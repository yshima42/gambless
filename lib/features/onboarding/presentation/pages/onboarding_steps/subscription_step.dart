          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                // 機能リスト
                _buildFeatureItem(context, 'Basic recovery exercises'),
                _buildFeatureItem(context, 'Gambling urge tracking'),
                _buildFeatureItem(context, 'Basic statistical analysis'),
                _buildFeatureItem(context, 'Community access (read-only)'),
              ],
            ),
          ),
